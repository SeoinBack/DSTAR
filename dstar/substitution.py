...
class AtomAlter():
    ...
    def generalizer(self,motif_df):
        ...
        motif_df = self.get_binary(motif_df)
    ...
    def binary_subs(self,atom_set,motif_dict):
    ...
    def substitution(self, general_df, atom_set):
        """  
        ...
        for i,v in general_df.iterrows():
            ...
            for col, lst in zip(['FNN','Same','Sub'], [fnns,sames,subs]):
                subs_A, subs_B = self.binary_subs(atom_set,v[col])
                lst.append(subs_A)
                lst.append(subs_B)
